          ...
          columns={[
            ...
            },
            {
              ...
              render: (text: any, record: any) => (
                <Space size="middle">
                    <Button size="small" onClick={() => onModify(record)} disabled={(toNumber(record.status) > 1)}>编辑</Button>
                    <Popconfirm
                      title="确认付款？"
                      okText="确认"
                      cancelText="取消"
                    ...
                    >
                        <Button size="small" type="primary" ghost disabled={(toNumber(record.status) > 0)}>付款</Button>
                    </Popconfirm>
                    <Popconfirm
                        title="确认收货？"
                        okText="确认"
                    ...
                    >
                        <Button size="small" type="primary" ghost disabled={(toNumber(record.status) <= 1)}>收货</Button>
                    </Popconfirm>
                    <Popconfirm
                        title="确认取消订单？"
                        okText="确认"
                     ...
                     <Button size="small" onClick={() => Logistic(record)} disabled={(toNumber(record.status) <= 1)}>查看物流</Button>                   
